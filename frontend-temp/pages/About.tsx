            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-300 space-y-1">
                  <p>• BRONZE ($19/mo) = <span className="text-green-400 font-semibold">$3.80 monthly commission</span></p>
                  <p>• SILVER ($33/mo) = <span className="text-green-400 font-semibold">$6.60 monthly commission</span></p>
                  <p>• GOLD ($149/mo) = <span className="text-green-400 font-semibold">$29.80 monthly commission</span></p>
                  <p>• DIAMOND ($499/mo) = <span className="text-green-400 font-semibold">$99.80 monthly commission</span></p>
                </div>
              </div>
