...
const partnershipFeatures = [
  ...
  {
    icon: TrendingUp,
    title: "3-Stage Church Affiliate Network",
    description: "Access our proven 3-tier commission structure (20%/10%/5%) with sponsorship options for member onboarding, creating sustainable ministry multiplication and financial support.",
  },
  {
    icon: Shield,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 text-sm sm:text-base">
              Partner churches can build their affiliate network through our 3-stage commission structure while receiving Help Me Fund support when needed. Every church receives public recognition and becomes part of a growing network of supernatural ministries advancing God's Kingdom with power and integrity.
            </p>
          </div>
