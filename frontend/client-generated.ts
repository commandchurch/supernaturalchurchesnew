...
export namespace academy {
    ...
    export interface ListUserCertificatesResponse {
        certificates: Certificate[]
    }
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.listUserCertificates = this.listUserCertificates.bind(this)
         ...
         */
        public async listCourses(params: PaginationParams): Promise<ListCoursesResponse> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/academy/courses`, undefined, {query})
         ...
         */
        public async listUserCertificates(): Promise<ListUserCertificatesResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/academy/certificates/user`)
            return await resp.json() as ListUserCertificatesResponse
        }
...
export namespace church {
    export interface AchievementEvent {
        ...
        "event_data": PrayerWarriorEvent | BibleScholarEvent | SoulWinnerEvent | MiracleWorkerEvent | DiscipleshipLeaderEvent | ChurchPlanterEvent | TestimonySharedEvent | MinistryServiceEvent
        "occurred_at": string
        version: number
    }

    export type AchievementEventType = "PRAYER_WARRIOR_ACHIEVED" | "BIBLE_SCHOLAR_COMPLETED" | "SOUL_WINNER_MILESTONE" | "MIRACLE_WORKER_DOCUMENTED" | "DISCIPLESHIP_LEADER" | "CHURCH_PLANTER_ACTIVATED" | "TESTIMONY_SHARED" | "MINISTRY_SERVICE_COMPLETED"

    export interface AddChurchStaffParams {
        churchId: string
        fullName: string
        email: string
        mobile?: string
    ...
    export interface AddChurchStaffResponse {
        success: boolean
        staffMember: ChurchStaffMember
    }

    export interface AddPrayerMessageParams {
        prayerRequestId: number
        message: string
    }

    export interface AddPrayerMessageResponse {
        success: boolean
        messageId: number
    }
    ...
    export interface GetAchievementLeaderboardParams {
        rank?: SpiritualRank
        category?: string
        limit?: number
    }

    export interface GetAchievementLeaderboardResponse {
        leaderboard: LeaderboardEntry[]
        "total_count": number
    }

    export interface GetChurchStaffResponse {
        staffMembers: ChurchStaffMember[]
    }

    export interface GetPrayerConversationResponse {
    ...
    export interface SendStaffInvitationsParams {
        churchId: string
        staffIds: string[]
    }
    ...
    export type SpiritualRank = "BELIEVER" | "DISCIPLE" | "MINISTER" | "EVANGELIST" | "PASTOR" | "APOSTLE" | "CARDINAL"

    export interface SubmitAchievementEventParams {
        "event_type": AchievementEventType
        "event_data": any
    }

    export interface SubmitAchievementEventResponse {
        "event_id": string
    ...
    export interface UpdatePrayerStatusParams {
        prayerRequestId: number
        status: "resolved" | "unresolved"
        rating?: number
    }

    export interface UpdatePrayerStatusResponse {
        success: boolean
        message: string
    }

    export interface UpdateStaffCourseAccessParams {
        staffId: string
        courseIds: string[]
    }

    export interface UpdateStaffCourseAccessResponse {
        success: boolean
        staffMember: ChurchStaffMember
    }
    ...
    export interface ValidateAchievementParams {
        "event_type": AchievementEventType
        "event_data": any
    }

    export interface ValidateAchievementResponse {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.addChurchStaff = this.addChurchStaff.bind(this)
            this.addPrayerMessage = this.addPrayerMessage.bind(this)
            this.checkChurchApproval = this.checkChurchApproval.bind(this)
            this.createEvent = this.createEvent.bind(this)
            this.createTeaching = this.createTeaching.bind(this)
            this.deleteEvent = this.deleteEvent.bind(this)
            this.deleteTeaching = this.deleteTeaching.bind(this)
            this.getAchievementLeaderboard = this.getAchievementLeaderboard.bind(this)
            this.getChurchStaff = this.getChurchStaff.bind(this)
            this.getPrayerConversation = this.getPrayerConversation.bind(this)
            ...
            this.removeChurchStaff = this.removeChurchStaff.bind(this)
            this.replyPrayerRequest = this.replyPrayerRequest.bind(this)
            this.reviewTestimony = this.reviewTestimony.bind(this)
            this.sendStaffInvitations = this.sendStaffInvitations.bind(this)
            this.submitAchievementEvent = this.submitAchievementEvent.bind(this)
            this.submitPrayerRequest = this.submitPrayerRequest.bind(this)
            this.submitTestimony = this.submitTestimony.bind(this)
            this.updateEvent = this.updateEvent.bind(this)
            this.updatePrayerStatus = this.updatePrayerStatus.bind(this)
            this.updateStaffCourseAccess = this.updateStaffCourseAccess.bind(this)
            this.updateTeaching = this.updateTeaching.bind(this)
            this.validateAchievement = this.validateAchievement.bind(this)
        }

        /**
         * Add church staff member
         */
        public async addChurchStaff(params: AddChurchStaffParams): Promise<AddChurchStaffResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/church/staff/add`, JSON.stringify(params))
            return await resp.json() as AddChurchStaffResponse
        }

        /**
         * Add a message to a prayer request conversation
         */
        public async addPrayerMessage(params: AddPrayerMessageParams): Promise<AddPrayerMessageResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/church/prayer/message`, JSON.stringify(params))
            return await resp.json() as AddPrayerMessageResponse
        }

        /**
         * Check if user is from approved church
         */
        public async checkChurchApproval(userId: string): Promise<{
    /**
     * Check if user is from approved church
     */
    approved: boolean
    ...
    churchName?: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/church/approval/${encodeURIComponent(userId)}`)
    ...
    churchName?: string
        ...
        public async getAchievementLeaderboard(params: GetAchievementLeaderboardParams): Promise<GetAchievementLeaderboardResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/church/achievements/leaderboard`, undefined, {query})
            return await resp.json() as GetAchievementLeaderboardResponse
        }

        /**
         * Get church staff members
         */
        public async getChurchStaff(churchId: string): Promise<GetChurchStaffResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/church/staff/${encodeURIComponent(churchId)}`)
            return await resp.json() as GetChurchStaffResponse
        }

        /**
         * Get conversation messages for a prayer request
         */
        public async getPrayerConversation(prayerRequestId: number): Promise<GetPrayerConversationResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/church/prayer/conversation/${encodeURIComponent(prayerRequestId)}`)
            return await resp.json() as GetPrayerConversationResponse
        }
        ...
        public async getUserAchievements(params: GetUserAchievementsParams): Promise<GetUserAchievementsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/church/achievements/user`, undefined, {query})
            return await resp.json() as GetUserAchievementsResponse
        }
         ...
         */
        public async listEvents(params: PaginationParams): Promise<ListEventsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                limit:     params.limit === undefined ? undefined : String(params.limit),
                page:      params.page === undefined ? undefined : String(params.page),
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/church/events`, undefined, {query})
         ...
         * Remove staff member
         */
        public async removeChurchStaff(staffId: string): Promise<{
    /**
     * Remove staff member
     */
    success: boolean
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/church/staff/remove/${encodeURIComponent(staffId)}`)
            return await resp.json() as {
    /**
     * Remove staff member
     */
    success: boolean
         ...
         */
        public async sendStaffInvitations(params: SendStaffInvitationsParams): Promise<SendStaffInvitationsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/church/staff/send-invitations`, JSON.stringify(params))
            return await resp.json() as SendStaffInvitationsResponse
        }

        /**
         * Submit a spiritual achievement event
         */
        public async submitAchievementEvent(params: SubmitAchievementEventParams): Promise<SubmitAchievementEventResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/church/achievements/events`, JSON.stringify(params))
            return await resp.json() as SubmitAchievementEventResponse
        }
         ...
         */
        public async updatePrayerStatus(params: UpdatePrayerStatusParams): Promise<UpdatePrayerStatusResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/church/prayer/status`, JSON.stringify(params))
            return await resp.json() as UpdatePrayerStatusResponse
        }

        /**
         * Update staff course access
         */
        public async updateStaffCourseAccess(params: UpdateStaffCourseAccessParams): Promise<UpdateStaffCourseAccessResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PUT", `/church/staff/course-access`, JSON.stringify(params))
            return await resp.json() as UpdateStaffCourseAccessResponse
        }
        ...
        public async validateAchievement(params: ValidateAchievementParams): Promise<ValidateAchievementResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/church/achievements/validate`, JSON.stringify(params))
            return await resp.json() as ValidateAchievementResponse
        }
    }
}
...
export namespace fund {
    ...
    export class ServiceClient {
         ...
         */
        public async listNeeds(params: PaginationParams): Promise<ListNeedsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                limit:     params.limit === undefined ? undefined : String(params.limit),
                page:      params.page === undefined ? undefined : String(params.page),
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/fund/needs`, undefined, {query})
         ...
         */
        public async listTransactions(params: PaginationParams): Promise<ListTransactionsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                limit:     params.limit === undefined ? undefined : String(params.limit),
                page:      params.page === undefined ? undefined : String(params.page),
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/fund/transactions`, undefined, {query})
...
export namespace outreach {
    ...
    export interface ListUserRecruitsResponse {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.listUserRecruits = this.listUserRecruits.bind(this)
        ...
        public async getAffiliateStats(): Promise<AffiliateStats> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/outreach/affiliate/stats`)
         ...
         */
        public async listUserRecruits(): Promise<ListUserRecruitsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/outreach/recruits/user`)
            return await resp.json() as ListUserRecruitsResponse
        }
...
export namespace payment {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getCashflowAnalytics = this.getCashflowAnalytics.bind(this)
            this.getPayrollStatus = this.getPayrollStatus.bind(this)
            this.processBatchPayroll = this.processBatchPayroll.bind(this)
         ...
         */
        public async getCashflowAnalytics(): Promise<{
    ...
    launchPeriodCashflow: {
        ...
        daysRemaining: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/payment/cashflow/analytics`)
            return await resp.json() as {
    totalPendingCommissions: number
    totalPaidThisMonth: number
    averageCommissionSize: number
    ...
    launchPeriodCashflow: {
         ...
         */
        public async getPayrollStatus(): Promise<{
    ...
    launchDaysRemaining: number
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/payment/payroll/status`)
            return await resp.json() as {
    nextPayoutDate: string
    pendingAmount: number
    daysUntilPayout: number
    launchDaysRemaining: number
         ...
         */
        public async processBatchPayroll(): Promise<{
    processed: number
    totalAmount: number
    errors: string[]
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/payment/payroll/batch`)
            return await resp.json() as {
    processed: number
    totalAmount: number
    errors: string[]
...
export namespace user {
    ...
    export interface DownlineTierStats {
        tier: string
        totalPoints: number
        totalMembers: number
    ...
    export interface GetDownlineStatsResponse {
    ...
    export interface GetTicketConversationResponse {
        messages: ConversationMessage[]
    }

    export interface GetUserUpgradeHistoryResponse {
    ...
    export interface TrackBonusParams {
        userId: string
    ...
    export interface TrackBonusResponse {
        success: boolean
        bonusEarned: boolean
        message: string
        bonusAmount?: number
    ...
    export interface TrackSignupResponse {
        success: boolean
    ...
    export interface TrackUpgradeParams {
        userId: string
    ...
    export interface TrackUpgradeResponse {
        success: boolean
        commissionEligible: boolean
        message: string
        bonusTriggered?: {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.addSupportMessage = this.addSupportMessage.bind(this)
            ...
            this.getDownlineStats = this.getDownlineStats.bind(this)
            this.getMe = this.getMe.bind(this)
            this.getProfile = this.getProfile.bind(this)
            this.getTicketConversation = this.getTicketConversation.bind(this)
            this.getUserUpgradeHistory = this.getUserUpgradeHistory.bind(this)
            this.listSupportTickets = this.listSupportTickets.bind(this)
            this.trackBonus = this.trackBonus.bind(this)
            this.trackSignup = this.trackSignup.bind(this)
            this.trackUpgrade = this.trackUpgrade.bind(this)
         ...
         */
        public async addSupportMessage(params: AddSupportMessageParams): Promise<AddSupportMessageResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/support/message`, JSON.stringify(params))
            return await resp.json() as AddSupportMessageResponse
        }

        /**
         * Checks if a username is available
         */
        public async checkUsername(params: CheckUsernameParams): Promise<CheckUsernameResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/check-username`, JSON.stringify(params))
            return await resp.json() as CheckUsernameResponse
        }

        /**
         * Create a new support ticket
         */
        public async createSupportTicket(params: CreateSupportTicketParams): Promise<CreateSupportTicketResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/support/ticket`, JSON.stringify(params))
            return await resp.json() as CreateSupportTicketResponse
        }

        /**
         * Creates or updates a username for a user and generates their affiliate link
         */
        public async createUsername(params: CreateUsernameParams): Promise<CreateUsernameResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/create-username`, JSON.stringify(params))
            return await resp.json() as CreateUsernameResponse
        }
        ...
        public async getDashboardStats(): Promise<DashboardStats> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/user/dashboard/stats`)
         ...
         */
        public async getDownlineStats(): Promise<GetDownlineStatsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/user/downline/stats`)
            return await resp.json() as GetDownlineStatsResponse
        }
         ...
         */
        public async getTicketConversation(ticketId: string): Promise<GetTicketConversationResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/user/support/conversation/${encodeURIComponent(ticketId)}`)
            return await resp.json() as GetTicketConversationResponse
        }

        /**
         * Get user's upgrade history for admin dashboard
         */
        public async getUserUpgradeHistory(userId: string): Promise<GetUserUpgradeHistoryResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/user/upgrade-history/${encodeURIComponent(userId)}`)
            return await resp.json() as GetUserUpgradeHistoryResponse
        }

        /**
         * Get support tickets for the authenticated user
         */
        public async listSupportTickets(): Promise<ListSupportTicketsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/user/support/tickets`)
            return await resp.json() as ListSupportTicketsResponse
        }

        /**
         * Track bonus eligibility and award bonuses when requirements are met
         */
        public async trackBonus(params: TrackBonusParams): Promise<TrackBonusResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/track-bonus`, JSON.stringify(params))
            return await resp.json() as TrackBonusResponse
        }

        /**
         * Track new user signups and determine commission eligibility
         */
        public async trackSignup(params: TrackSignupParams): Promise<TrackSignupResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/track-signup`, JSON.stringify(params))
            return await resp.json() as TrackSignupResponse
        }

        /**
         * Track membership upgrades (especially FREE to PAID)
         */
        public async trackUpgrade(params: TrackUpgradeParams): Promise<TrackUpgradeResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/track-upgrade`, JSON.stringify(params))
            return await resp.json() as TrackUpgradeResponse
        }
         ...
         */
        public async updateTicketStatus(params: UpdateTicketStatusParams): Promise<UpdateTicketStatusResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/user/support/ticket/status`, JSON.stringify(params))
            return await resp.json() as UpdateTicketStatusResponse
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "supernaturalins-tmi2-Generated-TS-Client (Encore/v1.49.3)";
        }
